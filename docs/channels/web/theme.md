...
- [Bubble](/docs/channels/web/theme/bubble)
- [Input Styling](/docs/channels/web/theme/input-styling)
- [Theme Templates & Custom CSS](/docs/channels/web/theme/theme-templates)

For more advanced CSS-based customization, also see the dedicated [Custom CSS](/docs/channels/web/custom-css) page.

## Go to page which themes the widget
- Sign in to [Predictable Dialogs](https://predictabledialogs.com/sign-in). Click your existing agent. Click "Theme" on side bar.
