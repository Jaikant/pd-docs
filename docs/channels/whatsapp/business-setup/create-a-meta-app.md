...
1. **Access the App Creation Page**
   ...
   - If this is the first time you are coming to this page, click "Getting Started" on the top right corner. This will help you register your account as a meta developer.
...
4. **Add use cases**
    - Within the featured 6 use cases, select **Connect with customers through WhatsApp**

5. **Select the Business Portfolio** to which this app will belong.
